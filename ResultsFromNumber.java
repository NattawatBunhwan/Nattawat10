...
public class ResultsFromNumber extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbxSeparator.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ResultsFromNumber.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ResultsFromNumber().setVisible(true);
            }
        });
    }
